# GTM Engine — Sales Frameworks

A collection of practical sales frameworks for B2B founders going from 0 to 1. Each framework is designed to be learned, applied, and iterated on — not just read.

## Active Frameworks

| Framework | File | When to Use |
|-----------|------|-------------|
| **Discovery Questions** | [discovery-questions.md](discovery-questions.md) | Before any customer conversation. Crafting questions that produce honest, useful data instead of polite lies. |
| **Market Segments** | [market-segments.md](market-segments.md) | Planning your outreach strategy. Understanding where your buyers sit in terms of purchase readiness. |
| **Customer Profile** | [customer-profile.md](customer-profile.md) | Qualifying new prospects. Defining who to target at the market, account, and person level. |
...
- **The Framework** — The actual model, with tables and scoring where applicable
- **How to Apply It** — Step-by-step instructions
- **Workshop: Build Yours** — Exercises to make it yours
- **Example** — Generic B2B SaaS scenario showing the framework in action
- **Connection to Other Frameworks** — How it links to the rest of the system
- **Anti-Patterns** — Common mistakes and how to avoid them

## Contributing

These frameworks are open source. If you have improvements, additional examples, or new frameworks to contribute, open a PR. Keep frameworks generic (no company-specific references) and practical (every section should be actionable).
